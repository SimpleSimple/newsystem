...
<head>
	...
	<link rel="stylesheet" href="/newsystem/Public/css/layout.css" type="text/css" media="screen" />
	<!--[if lt IE 9]>
...
<body>
	...
	<header id="header">
		<hgroup>
			<h1 class="site_title"><a href="admin.php?c=admin">后台管理面板</a></h1>
	...
	<aside id="sidebar" class="column">
		<h3>登录后台</h3>
		<ul class="toggle">
			<li class="icn_security"><a href="index.php?c=admin">登录后台</a></li>
		</ul>
	...
	<section id="main" class="column">
		...
		<form id="form1" name="form1" method="post" action="index.php?c=admin&a=checkLo">
